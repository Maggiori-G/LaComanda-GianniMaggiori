...
class Pedido{
    ...
    public function crearPedido()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO pedido (codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre) VALUES (:codigoPedido, :idMesa, :idProducto, :nombreCliente, :sector, :estado, :importe, :cantidad, :fechaInicio, :fechaCierre)");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido");
        $consulta->execute();
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido WHERE estado = :estado");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido WHERE codigoPedido = :codigoPedido");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido WHERE idMesa = :idMesa");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido WHERE id = :id");
    ...
    public static function modificarPedido($pedido, $idNuevoProducto = false)
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE pedido SET idMesa = :idMesa, idProducto = :idProducto, nombreCliente = :nombreCliente, sector = :sector, importe = :importe, cantidad = :cantidad, estado = :estado WHERE id = :id");
    ...
    public static function borrarPedido($pedido) {
        $objAccesoDato = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDato->prepararConsulta("UPDATE pedido SET estado = :estado, fechaCierre = :fechaCierre WHERE id = :id");
    ...
    public static function obtenerTodosPorSector($sector){
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT id, codigoPedido, idMesa, idProducto, nombreCliente, sector, estado, importe, cantidad, fechaInicio, fechaCierre FROM pedido WHERE sector = :sector AND estado = :estado");
    ...
    {
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("UPDATE pedido SET estado = :estado WHERE id = :id");
        $consulta->bindValue(':id', $id, PDO::PARAM_INT);
